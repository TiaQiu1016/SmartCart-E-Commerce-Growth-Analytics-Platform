...
python src/segments_at_cutoff.py # pre-cutoff segments + future churn V2 validation
...
python src/generate_insight_brief.py  # structured JSON -> reviewed Markdown insight brief candidate
```
